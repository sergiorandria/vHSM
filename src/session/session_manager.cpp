...
SessionManager::SessionManager() : v_clock_(), v_core_(v_clock_) {}

SessionManager::~SessionManager() = default;

CK_RV SessionManager::openSession(CK_SLOT_ID slotID, CK_FLAGS flags,
  ...
  // Check if flags are valid (only CKF_RW_SESSION | CKF_SERIAL_SESSION
  // allowed).
...
CK_RV SessionManager::getSessionInfo(CK_SESSION_HANDLE hSession,
...
SessionManager::getSession(CK_SESSION_HANDLE hSession) {
