...
TEST_F(SignatureRepositoryTest, LedgerCrossCheckOnTamperedRow) {
  ...
  // Tamper with payload_digest directly in the DB (simulating a local
  // attacker).
  conn_->exec("UPDATE signature_records SET payload_digest = ? WHERE id = ?",
