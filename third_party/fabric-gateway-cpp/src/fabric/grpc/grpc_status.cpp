...
GrpcError::GrpcError(const std::string &what, ::grpc::StatusCode code,
                     const std::string &grpcMessage, const std::string &details)
    : std::runtime_error(what), code_(code), grpcMessage_(grpcMessage),
      details_(details) {}
...
StatusException::StatusException(::grpc::StatusCode code,
    ...
    : GrpcError("RPC failed with status " +
