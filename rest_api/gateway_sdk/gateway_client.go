...
// gateway utilisant les resources du SDK Fabric Gateway pour interagir avec le ledger Hyperledger Fabric
...
// /**
//  * GatewayClient encapsule la connexion Fabric Gateway + contract
//  */
// type GatewayClient struct {
// 	gw       *client.Gateway
...
// /**
//  * Initialise une connexion Gateway vers Fabric
//  */
...
// /**
//  * Fermeture propre de la connexion Gateway
//  */
// func (gc *GatewayClient) Close() error {
// 	return gc.gw.Close()
// }
...
// /**
//  * 🔥 Transaction WRITE (Create / Update / Delete)
//  */
// func (gc *GatewayClient) Submit(
// 	function string,
// 	args ...string,
// ) ([]byte, error) {

// 	result, err := gc.contract.SubmitTransaction(function, args...)
// 	if err != nil {
// 		return nil, fmt.Errorf("submit transaction failed (%s): %w", function, err)
// 	}
...
// /**
//  * 📖 Transaction READ (Query ledger)
//  */
// func (gc *GatewayClient) Query(
// 	function string,
// 	args ...string,
// ) ([]byte, error) {

// 	result, err := gc.contract.EvaluateTransaction(function, args...)
// 	if err != nil {
// 		return nil, fmt.Errorf("query failed (%s): %w", function, err)
// 	}
